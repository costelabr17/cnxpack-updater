...
*/
constexpr const char BRAND_ARTICLE[] = "O";
constexpr const char BRAND_FULL_NAME[] = "CostelaBR";
constexpr const char BRAND_FACEBOOK_GROUP[] = "Nintendo Switch - Hack e Homebrew Brasil";
constexpr const char APP_FULL_NAME[] = "CNX Pack Updater";
